mk_plot4<-function(verb=F){
    ...
    plot(strptime(sel_data$TimeStamp, format="%d/%m/%Y %H:%M:%S"), sel_data$Global_active_power, 
         ylab="Global Active Power", xlab="", type="l")
    
    plot(strptime(sel_data$TimeStamp, format="%d/%m/%Y %H:%M:%S"), sel_data$Voltage, 
    ...
    plot(strptime(sel_data$TimeStamp, format="%d/%m/%Y %H:%M:%S"), sel_data$Global_reactive_power, 
